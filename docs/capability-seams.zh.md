...
flowchart LR
  ...
  pkg_module_scheduler["module-scheduler"]
  svc_moduleScheduler["ctx.moduleScheduler<br/>Module scheduler"]
  pkg_module_scheduler_profile["module-scheduler-profile"]
  pkg_module_scheduler_web_profile["module-scheduler-web-profile"]
  ...
  pkg_module_scheduler --> svc_moduleScheduler
  ...
  svc_moduleScheduler --> pkg_module_scheduler_profile
  svc_moduleScheduler --> pkg_module_scheduler_web_profile
...
| `ctx.moduleScheduler` | `core` | `module-scheduler` | - | `module-scheduler-profile`、`module-scheduler-web-profile` | - | 拥有不可变模块定义、有界隔离运行和浏览器 Remote 投影。 |
