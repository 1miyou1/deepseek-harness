...
| `ctx.moduleScheduler` | `core` | `module-scheduler` | - | `module-scheduler-profile`, `module-scheduler-web-profile` | - | Owns immutable module definitions, bounded isolated runs, and the browser remote projection. |
