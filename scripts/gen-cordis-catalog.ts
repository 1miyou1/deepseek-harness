...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ModuleSchedulerView: 'module scheduler browser projection is owned by packages/experimental/module-scheduler/README.md',
  BrowserModuleRunRequest: 'module scheduler browser request is owned by packages/experimental/module-scheduler/README.md',
  ModuleStartResult: 'module scheduler start result is owned by packages/experimental/module-scheduler/README.md',
  ModuleCancelResult: 'module scheduler cancel result is owned by packages/experimental/module-scheduler/README.md',
