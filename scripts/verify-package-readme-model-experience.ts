...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/experimental/module-scheduler': { kind: 'indirect', reason: 'Module consumers own selection and model rendering; the service only dispatches declared tools through dsh-tools.' },
